...
Validators are trudag tools used to validate any data that can be reduced to a floating point metric. The resulting score can be attached to items in the Trustable Software graph as evidence.
